...
`Zamboni@2026`. This is a client-side gate, not real auth — see
`.claude/CLAUDE.md`'s 2026-07-08 login-page entry if asked about it.
...
2. **Step 2 — Upload Completed Mapping**: upload a filled-in CSV (or the
   ...
   works — this exact scenario was a real bug fixed on 2026-07-07, see
   `.claude/CLAUDE.md`). Point at the dry-run preview grid — "N will be
